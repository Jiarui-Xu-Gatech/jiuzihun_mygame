...
game.import('card',function(lib,game,ui,get,ai,_status){
	return {
		...
		translate:{
			...
			hanbing_skill:'百草仗',
			renwang_skill:'九幽坎肩',
			hanbing_info:'当你使用冲造成伤害时，你可以防止此伤害，改为依次弃置目标角色的两张牌。',
			hanbing_skill_info:'当你使用冲造成伤害时，你可以防止此伤害，改为依次弃置目标角色的两张牌。',
			renwang_info:'锁定技，黑色的冲对你无效',
			renwang_skill_info:'锁定技，黑色的冲对你无效',
