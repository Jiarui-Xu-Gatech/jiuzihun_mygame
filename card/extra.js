				...
				content:function(){
					...
					if (player.storage.muniu_skill6&&player.storage.muniu_skill6.length>0){
						...
						if (player.isUnderControl(true)){
							game.addVideo('showCards',player,['木牛流马',get.cardsInfo(muniucards)]);
						}
						else{
							game.addVideo('showCards',player,['木牛流马',get.cardsInfo(muniucards),'hidden']);
							var dialog=ui.create.dialog('木牛流马',[get.cardsInfo(muniucards),'blank']);
							setTimeout(function(){
								dialog.close();
							},1000);
						}
