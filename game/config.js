window.config={
	...
	all:{
		sgscharacters:['jiuzisha','standard','shenhua','xinghuoliaoyuan','refresh','yijiang','sp','sp2','extra','old','mobile','tw'],
		sgscards:['jiuzihunCard','standard','extra','sp','guozhan','zhulu'],
	...
	longpress_info:true,
	long_info:true,
	background_music:'music_envSwordEnd',
